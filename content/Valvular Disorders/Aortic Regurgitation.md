...
- When AR is detected, the evaluation starts:[^1]
	- assessment of the anatomy of the [[Aortic Valve|aortic valve]] and [[Aortic Root|root]] to determine the etiology of the regurgitation
	- an assessment of LV size, geometry, and function 

![[Aortic Regurgitation-1763519344156.webp]]

![[Aortic Regurgitation-1763519381632.webp]]
...
- AR usually lasts throughout diastole except in [[Aortic Regurgitation#Acute Aortic Regurgitation|acute AR]], where it may be brief and of lower velocity, making detection and assessment with color Doppler more difficult.[^1]
...
![[Aortic Regurgitation-1763522208291.webp]]


> [!tip] LV should be dilated with chronic AI (and MR)
> Chronic severe AR almost always leads to **dilated LV**, and thus, normal chamber volumes are unusual with chronic severe AR.[^1]


![[Aortic Regurgitation-1763521228709.webp]]
...
$$
\begin{align}
\text{Regurgitant flow rate} &=  2 \pi r^2 \cdot V_{\text{aliasing}} (\text{cm/s}) \\
\text{EROA} &= \frac{\text{Regurgitant flow rate (cm}^3 \text{/s)}}{\text{Peak AI velocity } (\text{cm/s})} \\
\text{RVol} &= \text{EROA} \times \text{VTI}
\end{align}
$$
![[Aortic Regurgitation-1763521583666.webp]]

- Measurement of the AR peak velocity and VTI by [[Continuous Wave Doppler|CWD]] allows calculation of the **EROA** and **RVol**
	- The threshold for severe AR is an EROA ≥0.30 cm^2 and an RVol > 60 mL
- ![[Aortic Regurgitation-1763520748706.webp]]
- ![[Aortic Regurgitation-1763520775789.webp]]
- ![[Aortic Regurgitation-1763520829912.webp]]

$$
\text{RVol} = \text{SV}_{\text{LVOT}} - \text{SV}_{\text{MV}}
$$
