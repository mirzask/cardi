...
- LA dilation
	- LA dilation is an expected consequence of <font color="#c00000">severe MR</font>. A normal LA size generally *excludes* severe chronic MR. LA volumes are superior to LA diameters in evaluating LA dilation and in predicting outcomes and atrial fibrillation. However, LA dilatation can occur in many disease states including [[Hypertension|hypertension]] and [[Atrial Fibrillation (AFib)|AFib]]. ∴, a dilated LA does *not* necessarily imply severe MR.
...
![[Mitral Regurgitation-1745289979787.webp]]
...
- A flail leaflet is part of the [[Mitral Valve Prolapse (MVP)|MVP]] spectrum and occurs when the leaflet edge, not just the leaflet body, is located in the LA with free motion. It occurs most commonly from rupture of the marginal chords. A flail leaflet almost always denotes severe MR and is clearly associated with adverse outcomes. An extreme of flail MV is [[Mitral Regurgitation#Papillary muscle rupture|papillary muscle rupture]].
...
- Although jet area is excellent for excluding MR, it is not reliable for grading MR severity, even when indexed for LA area.
	- Patients with [[Mitral Regurgitation#Acute MR|acute severe MR]], in whom blood pressure is low and LA pressure is elevated, may have a *small* color flow jet area, whereas hypertensive patients with mild MR may have a large jet area. 
...
- VC width
	...
	- VC < 0.3 cm usually denotes <font color="#76923c">mild</font> MR
	- VC ≥ 0.7 cm is specific for <font color="#c00000">severe</font> MR.
	- Intermediate values overlap substantially between MR grades, so additional methods should be used for confirmation. 
	- VCW works equally well for central and eccentric jets, however, it is dependent on orifice geometry, underestimating MR severity if there are multiple jets or if there is a markedly elliptical (noncircular) orifice shape, as often seen in [[Mitral Regurgitation#Secondary Mitral Regurgitation|secondary MR]].
...
$$
$$
\text{Regurgitant Volume (R}_\text{vol}) = \text{EROA} \times \text{VTI}_{\text{Regurg}}
$$


- Interpretation (at least in [[Mitral Regurgitation#Primary Mitral Regurgitation|primary MR]]):
	- EROA ≥0.4 cm2 → severe MR
	- 0.20-0.39 cm2 → moderate MR
	- <0.20 cm2 → mild MR
- ⚠️ In MR, PISA is more accurate for <u>central</u> regurgitant jets than <u>eccentric</u> jets and for circular orifices than noncircular orifices. 
...
- The regurgitant orifice is often crescent shaped in [[Mitral Regurgitation#Secondary Mitral Regurgitation|secondary MR]]. In such cases, the assumption of circular orifice geometry inherent to 2D PISA may result in <u>underestimation</u> of [[Mitral Regurgitation#Secondary Mitral Regurgitation|secondary MR]]. 
...
- [[Continuous Wave Doppler|CWD]] should also be used to interrogate the [[Tricuspid Regurgitation|TR]] jet to estimate PA systolic pressure, another indirect clue as to MR severity and compensation for the volume overload.
...
- One limitation of the pulmonary venous pattern is that elevation in LA pressure of any etiology as well as atrial fibrillation may also result in a blunted systolic forward flow. Thus, systolic blunting is less valuable in [[Mitral Regurgitation#Secondary Mitral Regurgitation|secondary MR]] than in [[Mitral Regurgitation#Primary Mitral Regurgitation|primary MR]]. ∴, the pulmonary venous flow pattern should be used adjunctively with other parameters. 
...
# When to get [[Transesophageal Echocardiography (TEE)|TEE]]?
...
2. Methods of MR Quantitation. MR can be assessed using several techniques by CMR. This includes qualitative or semiquantitative visual assessment of MR jet based on spin dephasing in the LA, 153 measurement of the VCA or anatomical regurgitant orifice area on short-axis cine of phase-contrast images, 77,154 and quantification of RVol and RF. 155-157 Among these techniques, quantification of RVol and fraction is recommended (Figures 8 and 17). The suggested preference order for calculation of RVols is the use of
	1. The difference between LV SV using planimetry of short-axis cine images and aortic SV obtained by phase-contrast images
	2. The difference in LV and RV SV by endocardial contouring of LV and RV cine images
	3. The difference between the mitral inflow SVand aortic SV by phase-contrast imaging
