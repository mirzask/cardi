...
- "**[[Accessory Pathway Conduction|WPW]] pattern**" is asymptomatic pre-excitation, whereas "**[[Accessory Pathway Conduction|WPW]] syndrome**" involves symptomatic arrhythmia.
- Characterized by:
	- short [[PR interval]]
		- [[PR interval]] < 120 ms
	- Normal [[P wave]] vector (to exclude junctional rhythm)
	- Prolonged [[QRS interval]]
		- [[QRS interval|QRS]] duration > 100 ms
	- **Delta wave**
...
- ⚠️ For someone with [[Accessory Pathway Conduction|WPW]], you won't see the delta waves while they're in [[Supraventricular Tachycardia (SVT)|SVT]]
- ![[AV Reentrant Tachycardia _AVRT_-1745549180943.webp]]
- Concern of [[Accessory Pathway Conduction|WPW]] progressing
		- ![[AV Reentrant Tachycardia _AVRT_-1745549218573.webp]]
...
- ☠️ The chief fear of both WPW syndrome and pattern is the risk for [[Sudden Cardiac Death (SCD)|sudden cardiac death (SCD)]] – presumed to result from rapid VPE precipitating [[Ventricular Fibrillation (VFib)|VFib]].
- 3 major arrhythmias:
	- [[AV Nodal Reentrant Tachycardia (AVNRT)|ORT]]
		- regular
		- <u>narrow</u> QRS (wide QRS if aberrancy)
	- [[AV Reentrant Tachycardia (AVRT)|Antidromic AVRT]]
		- regular
		- <u>wide</u> QRS
	- [[Atrial Fibrillation (AFib)|AFib]] associated with an [[Accessory Pathway Conduction|accessory pathway]]
	- ![[Accessory Pathway Conduction-1745549601783.webp]]
