...
- Clinical definition
	- frequent symptoms that occur with standing
		...
		- often with standing HRs >120 bpm [^2]
	- ↑ in HR of ≥30 bpm when going from lying to standing or upright tilt (or ≥40 bpm in those 12 to 19 years of age)
		- 📝 the tachycardia of POTS is a sinus tachycardia [^2]
	- absence of [[Orthostatic Hypotension|orthostatic hypotension]]
- Typical demographic is young women (mean age 30.2 ± 10.3 years, 86% women), with an average HR increment of 44.2 ± 13.2 beats/min from supine to upright in the absence of provocative medications such as nitroglycerin or isoproterenol. [^2]
- Frequently preceded by symptoms of a viral illness (in 42%) or may occur post-operatively (in 9.5%) [^2]

> [!warning] [[Syncope#Vaso-vagal syncope|Vasovagal syncope]]
> POTS and [[Syncope#Vaso-vagal syncope|VVS]] are *NOT* mutually exclusive. Up to 30% of POTS patients may experience syncope, and these patients may have both [[Syncope#Vaso-vagal syncope|VVS]] and POTS, because these disorders can occur together.[^2]
...
- Selected patients (based on history)
	...
	- Autonomic testing
	- Echo
		- The cardiologist who first evaluates a patient for POTS must also exclude structural cardiac disease that would reduce upright stroke volume, including valvular heart disease, cardiac tumors or other causes of right or left ventricular outflow tract obstruction, pulmonary hypertension, undiagnosed congenital heart disease, or acquired myocardial diseases.[^2]
	- [[Tilt Table test]]
	- [[Exercise ECG]]
...
- Compression garments and/or Abdominal binders[^2]
...
- Counter maneuvers at the onset of prodromal symptoms in those with [[Syncope#Vaso-vagal syncope|VVS]]
	- ![[Syncope-1747668159404.webp|498x263]]
- Avoid triggers
	- Environmental heat, prolonged upright posture, prolonged fasting, excessive alcohol intake, straining (such as during urination or bowel movements), or vasodilatory medications will exacerbate orthostatic intolerance and should be avoided when possible.[^2]
