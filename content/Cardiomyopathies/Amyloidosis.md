...
- Echo: 
	- LV wall thickness >1.2 cm (0.6 cm to 1.0 cm is normal) in the absence of hypertension should prompt suspicion for CA. [^clinic]
		- LVH is most commonly symmetric, but you may see asymmetric septal hypertrophy, particularly in ATTRwt-CA [^clinic]
	- [[Strain Imaging]] with “apical sparing,” in which the apical LV segments have normal or near-normal strain compared with the mid and basal segments. [^clinic]


> [!tip] Discordance: LVH on Echo and Low-voltage on ECG
> If you see LVH on echo but low-voltage on ECG, you should definitely suspect cardiac amyloidosis.


- ECG may show low-voltage and pseudo-infarct pattern (Q waves in early precordial leads, V1-V2) mimicking prior anteroseptal MI. [^clinic]
	...
	- ![[Amyloidosis-1745705359501.webp]]

# Pathophysiology

![[Amyloidosis-1745705297568.webp]]
...
- When both aortic stenosis and ATTR cardiac amyloid occur together, patients will often have [[Aortic Stenosis#Low-flow, Low-gradient AS|low-flow, low-gradient AS]] because of the stiff heart's restrictive physiology (→ *low* stroke volume index)
	- recall, paradoxical [[Aortic Stenosis#Low-flow, Low-gradient AS|low-flow, low-gradient AS]] occurs with an AVA ≤ 1.0 cm2 with ∆P < 4 m/s and MG < 40 mmHg with preserved ejection fraction (≥ 50%) and SVI < 35 mm/m2

# Burnt-out Amyloid


> [!tip]+ Severe HTN is unlikely to be advanced amyloid
> 


- If there is enough accumulation of amyloid fibrils, systolic dysfunction can occur → LV unable to adequately perfuse the brain and other organs. These patients may present with bad congestion, but also poor forward flow that is manifested in normal blood pressures despite a history of hypertension and intolerance to neurohomonal blockade, such as [[Beta-blockers|BBs]], [[Renin-angiotensin-aldosterone system inhibitors (RAASi)|RAASi]], etc.
